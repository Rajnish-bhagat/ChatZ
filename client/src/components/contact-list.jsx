                            ...
                            <Avatar className="h-10 w-10 rounded-full overflow-hidden">
                                {
                                    contact.image ? (
                                        ...
                                        />) 
                                        : (<div className={` ${selectedChatData && selectedChatData._id === contact._id ? "" : "bg-[#ffffff22] border-2 border-white/70"} uppercase h-10 w-10 text-lg border-[1px] flex items-center justify-center rounded-full`}>
                                        {
